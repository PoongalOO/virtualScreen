 ...
 *
 * La conversion des pixels (chemin rapide pour [PixelFormat.XRGB_8888_LE], générique sinon) est celle
 * de [PixelConverter], partagée avec Hextile.
 *
...
class RawDecoder(
    ...
    private val converter: PixelConverter
    ...
    init {
        ...
        converter = PixelConverter(pixelFormat)
        bytesPerPixel = converter.bytesPerPixel
    ...
    override fun decode(socket: RfbSocket, x: Int, y: Int, w: Int, h: Int, framebuffer: Framebuffer) {
        ...
        for (row in 0 until h) {
            ...
            converter.convert(rowBytes, w, rowPixels)
